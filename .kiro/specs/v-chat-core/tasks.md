...
- [x] 2. 認証システムの実装
- [x] 2.1 Firebase Authentication設定とプロバイダー実装
...
- [ ] 3. データベースとAPI基盤の構築
- [ ] 3.1 Firestore設定とセキュリティルール
  - Firebase プロジェクトでFirestoreを有効化する
  - Firestoreセキュリティルールを設定する
  - Firestore接続とクエリヘルパーを実装する
...
- [ ] 4. ユーザープロフィール機能の実装
- [ ] 4.1 ユーザーモデルとFirestore操作
  - ユーザー情報のFirestoreドキュメント構造とバリデーションを実装する
  - プロフィール作成、更新、取得のFirestore操作を実装する
  - Cloud Functionsでユーザー名の重複チェック機能を実装する
