...
import { Sparkles, Lock, Users, ArrowLeft, Copy, CheckCircle, Users as UsersIcon } from 'lucide-react';
        ...
        <Card className="w-full max-w-2xl mx-auto shadow-2xl border-0 px-4">
          <CardHeader className="text-center pb-2">
            <div className="flex items-center justify-center mb-4">
              ...
              <CardTitle className="text-2xl font-bold text-gray-800">ルーム作成完了！</CardTitle>
            </div>
          </CardHeader>
          <CardContent>
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-6 border border-green-200">
                <h3 className="text-lg font-semibold text-gray-800 mb-4">{createdRoom.name}</h3>
              ...
              <div className="bg-blue-50 rounded-lg p-4">
                <h4 className="text-sm font-semibold text-blue-800 mb-2">ルームIDの共有方法</h4>
                <ul className="text-xs text-blue-700 space-y-1">
                  <li>• 上記のルームIDをコピーして他のユーザーに送信</li>
                  <li>• 他のユーザーは「ルームを探す」→「ルームIDを入力して参加」で参加可能</li>
